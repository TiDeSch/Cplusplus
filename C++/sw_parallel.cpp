...
using real_t = float;
constexpr size_t NX = 4096, NY = 4096; //World Size
using grid_t = std::array<std::array<real_t, NX>, NY>;

class Sim_Configuration {
public:
    int iter = 500;  // Number of iterations
...
public:
    ...
    Water() {
        ...
        #pragma acc enter data create(u, v, e)
        ...
        #pragma acc update device(e) async
    }

    ~Water() {
        #pragma acc exit data delete(u, v, e)
